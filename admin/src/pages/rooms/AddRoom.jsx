...
function AddRoom() {
  ...
  // Check for property_id in URL query params
  useEffect(() => {
    ...
    <div className="p-5">
      ...
      <form action="" onSubmit={handleSubmit(onSubmitForm)}>
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              type="number"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              {...register("discount", { max: 100, min: 0, required: false, value: 0 })}
            />
        ...
        <div className="mt-5">
          <button
            type="submit"
            disabled={isPending || isLoadingProperties}
            className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          >
            {isPending ? <LoadingSpinner /> : "Create Room"}
          </button>
        </div>
      </form>

        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text"
              defaultValue={
                reservation?.guests ? `${reservation.guests.fullname} - ${reservation.guests.phone || 'No phone'}` : ""
              }
              disabled={true}
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.price?.type === "min" && (
              <p className="text-sm text-red-700 italic">Price must be a positive number</p>
            )}

...
function Overlay({ children, modalKey }) {
  ...
  // Add null check for modalKey to prevent "Cannot read properties of null (reading 'length')" error
  if (isOpen && modalKey != null && modalKey === activeModal) return createPortal(children, document.body);
